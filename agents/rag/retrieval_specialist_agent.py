...
class RetrievalSpecialistAgentState(BaseModel):
    """State for RetrievalSpecialistAgent LangGraph workflow using Pydantic BaseModel."""
...
class RetrievalSpecialistAgent(EnhancedBaseAgent):
    ...
    def _build_langgraph_workflow(self) -> StateGraph:
        """Build LangGraph workflow for RetrievalSpecialistAgent."""
    ...
    async def _langgraph_execute_node(self, state: RetrievalSpecialistAgentState) -> RetrievalSpecialistAgentState:
...
def get_graph():
    ...
    if _default_instance is None and LANGGRAPH_AVAILABLE:
        ...
        config = AgentConfig(
            ...
            name='RetrievalSpecialistAgent',
            description='RetrievalSpecialistAgent agent',
            model_name='gemini-2.5-flash'
        )
        _default_instance = RetrievalSpecialistAgent(config)

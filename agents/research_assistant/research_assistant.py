...
# Get API key from Streamlit secrets, fallback to environment variable
try:
    # Try to get from Streamlit secrets (dictionary-style access)
    api_key = st.secrets.get("GEMINI_API_KEY", os.environ.get("GEMINI_API_KEY"))
except (AttributeError, RuntimeError, KeyError, TypeError):
    # Fallback if Streamlit is not available or secret not found

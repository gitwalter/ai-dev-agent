...
class SynthesisAgentState(BaseModel):
    """State for SynthesisAgent LangGraph workflow using Pydantic BaseModel."""
...
"""
    ...
    def _build_langgraph_workflow(self) -> StateGraph:
        """Build LangGraph workflow for SynthesisAgent."""
    ...
    async def _langgraph_execute_node(self, state: SynthesisAgentState) -> SynthesisAgentState:
...
def get_graph():
    ...
    if _default_instance is None and LANGGRAPH_AVAILABLE:
        ...
        config = AgentConfig(
            ...
            name='SynthesisAgent',
            description='SynthesisAgent agent',
            model_name='gemini-2.5-flash'
        )
        _default_instance = SynthesisAgent()

...
class VerificationAgentState(BaseModel):
    """State for VerificationAgent LangGraph workflow using Pydantic BaseModel."""
...
"""
    ...
    def _build_langgraph_workflow(self) -> StateGraph:
        """Build LangGraph workflow for VerificationAgent."""
    ...
    async def _langgraph_execute_node(self, state: VerificationAgentState) -> VerificationAgentState:
...
def get_graph():
    ...
    if _default_instance is None and LANGGRAPH_AVAILABLE:
        ...
        config = AgentConfig(
            ...
            description='VerificationAgent agent',
            model_name='gemini-2.5-flash'
        )
        _default_instance = VerificationAgent()
